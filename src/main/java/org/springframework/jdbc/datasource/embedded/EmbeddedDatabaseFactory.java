 ...
 * Call {@link #setDatabaseType(EmbeddedDatabaseType)} to set the database type if you wish to use one of the supported
 * types.<br>
 * Call {@link #setDatabaseConfigurer(EmbeddedDatabaseConfigurer)} to configure support for your own embedded database
 * type.<br>
 * Call {@link #setDatabasePopulator(DatabasePopulator)} to change the algorithm used to populate the database.<br>
 * Call {@link #setDataSourceFactory(DataSourceFactory)} to change the type of DataSource used to connect to the
 * database.<br>
...
public class EmbeddedDatabaseFactory
{
    ...
    /**
     * Hook to shutdown the embedded database. Subclasses may call to force shutdown. After calling,
     * {@link #getDataSource()} returns null. Does nothing if no embedded database has been initialized.
     */
     ...
     * <p>
     * Returns {@code null} if the DataSource has not been initialized or the database has been shut down. Subclasses
     * may call to access the DataSource instance directly.
     */
